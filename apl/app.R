...
# UI ----
ui <- navbarPage("Distribusi Sampling Statistik",
      navbarMenu("Proporsi",
         ## Tab proporsi satu sampel ----
                    ...
                    tabsetPanel(type = "tabs",
                                ...
                                tabPanel("Beberapa Sampel",
                                         ...
                                         div(h4(textOutput("num.samples.prop")),
                                             align ="center")),
                                tabPanel("Bentuk Distribusi Sampling",
                                         br(),
         ...
         ## Tab proporsi dua sampel ----
         tabPanel("Dua Sampel"
           
         ),
         ## Tab proporsi banyak sampel ----
         tabPanel("Banyak Sampel"
      ...
      sidebarLayout(
                 sidebarPanel(
                   ...
                   wellPanel(
                     ...
                     sliderInput("n_rrt", "Ukuran sampel:",
                                 value = 30, min = 2, max = 500),
                     hr(),
                     ### Menentukan banyak sampel ----
                     sliderInput("k_rrt", "Banyaknya sampel:",
                 ...
                 mainPanel(
                   tabsetPanel(
                     ...
                     tabPanel(title = "Distribusi Populasi",
                              br(),
                              plotOutput("pop.dist.rrt", height = "500px"),
                              br()
                              ),
                     ### Tab beberapa sampel ----
      ...
      tabPanel("Informasi",
               sidebarLayout(
                 sidebarPanel(
                   wellPanel(
                     div(h4("Deskripsi", style = "font-size: inherit; font-weight: bold")),
                   ...
                   wellPanel(
                     div(h4("Kode sumber", style = "font-size: inherit; font-weight: bold")),
                   ...
                   wellPanel(
                     div(h4("Lisensi", style = "font-size: inherit; font-weight: bold")),
                     div(p("Lisensi MIT"),
                 ...
                 mainPanel(
                   ...
                   hr(),
                   div(h4("Penafian tentang penggunaan AI:", style = "font-size: inherit; font-weight: bold")),
